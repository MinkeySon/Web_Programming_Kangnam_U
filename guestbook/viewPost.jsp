			...
			<div class="form-group">
				<form method="post" action="/post.nhn?action=updatePost&aid=${post.aid }">
					...
					<div class="row justify-content-center">
						<button class="btn btn-primary" type="button" onclick="validateInputs()">Corret</button>
						<a class="btn btn-info btn-lg m-2" href="post.nhn?action=deletePost&aid=${post.aid}" role="button">Delete</a>
